...
class WhatsAppController extends Controller
{
    ...
    function conversacion($mensajeRecibido)
    {
        ...
        switch ($mensajenoTilde) {case $util->convertirMinNoTilde("¡Hola! Me gustaría obtener más información sobre sus servicios de viaje. ¿Podrían proporcionarme detalles sobre los destinos, paquetes disponibles y precios?"):
                return  "¡Hola! Claro, aquí tienes tres opciones de paquetes de viaje:\nDestino: Cancún, México\nPaquete Todo Incluido: 7 días y 6 noches en una habitación doble.Precio: $1500 por persona.Servicios: Playa privada, acceso ilimitado al spa y actividades acuáticas.\n
            ...
            case $util->convertirMinNoTilde("Me interesa el paquete número 2, a París"):
                ...
                break;
            case $util->convertirMinNoTilde("Voy con mi pareja, plan romantico"):
                return "Excelente, ¿en qué fechas te gustaría reservar tu viaje a París?";
                break;
            case $util->convertirMinNoTilde("Voy con mi pareja, plan romantico"):
                return "Excelente, ¿en qué fechas te gustaría reservar tu viaje a París?";
                break;
            case $util->convertirMinNoTilde("Del 15 al 19 de mayo"):
                ...
                break;
            case $util->convertirMinNoTilde("Paul Alexander Romero, paulromero90@gmail.com, 0998557785"):
                ...
                break;
            case $util->convertirMinNoTilde("Eso seria todo, Gracias"):
