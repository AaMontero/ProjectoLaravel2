<x-app-layout>
    ...
    <div class="py-2">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('hoteles.store') }} " enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div>
                                <button type="button" id="agregar-servicio-btn" class="mt-1 bg-blue-950 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline">
                        ...
                        <div>
                            <button type="button" id="agregar-opinion-btn" class="mt-1 bg-blue-950 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline">
                        ...
                        <input type="file" name="imagen_hotel[]" id="imagen_hotel" class="form-control mb-2" multiple>
        ...
        agregarOpinionBtn.addEventListener('click', function() {
            ...
            nuevaOpinionInput.className = 'mt-3 block w-full rounded-md border-gray-300 bg-white shadow-sm transition-colors duration-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50';
